...
var STEP_UI = {
  ...
  pwr_heatup_nuclear: [
    ...
    { i: 5,  view: 'board', control: 'Pressure SP' },
    { i: 6,  view: 'board', control: 'Accumulator valve' },
    { i: 7,  view: 'board', control: 'SR detector' },
    { i: 8,  view: 'board', control: 'Trip Blocks' },
    { i: 9,  view: 'board', control: 'Trip Blocks' },
    { i: 10, view: 'board', control: 'Control Bank' },
    { i: 11, view: 'board', control: 'Control Bank' },
    { i: 12, view: 'board', control: 'Control Bank' },
    { i: 13, view: 'board', control: 'Boron control' },
    { i: 14, view: 'board', control: 'Boron control' },
    { i: 15, view: 'board', control: 'Control Bank' },
    { i: 16, view: 'board', control: 'Boron control' },
    { i: 17, view: 'board', control: 'Boron control' },
  ],
