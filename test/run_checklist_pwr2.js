...
if (!only && RUN_B) {
  ...
  (function () {
    ...
    (function () {
       ...
       * boron for temperature), sole 28 -> 27 (12 is no longer one row). SUM these deltas on a merge. */
      ck('2ae.1b the re-measured pool counts are the pinned ones (#773, re-pinned 2026-09-25 (b): 85 / 149 / 94 / 27)',
         gradedSteps === 85 && predRows === 149 && rows.length === 94 && soleInst === 27,
