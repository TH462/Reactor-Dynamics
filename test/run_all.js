...
var BASELINES = {
  ...
  'run_portable.js':       { code: 0, score: '138checks 0failed' },   // 137 -> 138 (2026-08-09, #432): ui/diag_recorder.js is a new <script src> in the shell, and this gate scans the shell's own tag list — so a new script raises the tally on its own, which is the self-maintaining property working, not drift.
