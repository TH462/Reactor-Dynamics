...
var BASELINES = {
  ...
  'run_pwr2_damage.js':    { code: 0, score: '43passed 0failed 43checks', secs: 6 },   // CLAD OXIDATION AND CORE DAMAGE, added 2026-08-17 (#479). NOTHING IN IT IS FITTED: Baker-Just with both constants and its 1510 cal/g heat of reaction (Ginna UFSAR ch15, mandated by 10 CFR 50 App K), the stoichiometry stated in words by GEND-061, the UO2 melting point, and all three 10 CFR 50.46 criteria -- every one quoted from the corpus. The gate checks the law REPRODUCES ITS OWN SOURCES at points they state independently of it: negligible at GEND-061's 1200 degF onset (0.066 %/100 s), appreciable at Ginna's 1800 degF (1.78 %), 7.04 % at the 2200 degF limit against 50.46's own 17 % ceiling -- with NO onset threshold in the code, only an Arrhenius exponent.
