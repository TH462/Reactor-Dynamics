...
var BASELINES = {
  ...
  'run_pwr2_loadfollow.js':{ code: 0, score: '21passed 0failed 21checks', secs: 70 },   // THE ACCEPTANCE TEST: Tier A coupling A1, power follows load, rods in MANUAL. Measured 99.6 -> 54.2 % with Tavg 577.7 -> 598.5 degF against the first engine's 100 -> 57.5 % and 579.3 -> 602.1. Bands admit the declared physics differences (real L0 density in the moderator coefficient, derived rather than tuned fuel rise); they are NOT fitted to the first engine.
