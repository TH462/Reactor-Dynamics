...
var BASELINES = {
  ...
  'run_hardrules.js':                          { code: 0, score: '311checks 0failed' },   // 309 -> 311 (2026-08-15, #479): TWO new HR11 sites -- the A/B re-baselining ruling and the workbench-worktree directive, both in PWR2_DESIGN sec 25. | 306 -> 309 (2026-08-14, #479): THREE new HR11 sites -- the vessel-proportions ruling and the form-loss declared-unsourced ruling in PWR2_PLANT sec 7, and the PWR2 merge hold in CLAUDE.md. | 305 -> 306 (2026-08-14): ONE new HR11 site -- the re-issued bring-the-recommendation directive in CLAUDE.md Blueprint/SOP block. TRAP, SECOND TIME TODAY: my draft citation carried the owner's verbatim words but NO DATE, and run_hardrules rejected it. The scan wants BOTH; a quote alone is not provenance. | 304 -> 305 (2026-08-14, #479): ONE new HR11 site -- the ruling commissioning the independent Layer 0 review, cited in PWR2_L0_REBUILD sec 7. | 303 -> 304 (2026-08-14, #479): ONE new HR11 site -- the geometry declaration ruling in PWR2_DESIGN sec 24. | 302 -> 303 (2026-08-14, #479): ONE new HR11 site -- the ruling approving the Layer 0 rebuild, cited in Blueprint/PWR2_L0_REBUILD.md. | 300 -> 302 (2026-08-14): TWO new HR11 sites -- the spell-out-every-code directive, cited in CLAUDE.md Domain conventions and in the PWR2_DESIGN decoder table. | 297 -> 300 (2026-08-14, #479): THREE new HR11 sites -- the large-break ruling (D1 sec 23) recorded in PWR2_DESIGN, PWR2_PHYSICS sec 23.3 (CCFL out of the required set) and PWR2_PLANT sec 8. TRAP WORTH THE LINE: my first draft of the PHYSICS_sec23.3 citation wrote "(OWNER RULING, 2026-08-14)" with NO verbatim quote, and run_hardrules caught it as an undeclared site -- the scan is not a file count and not a date check, it wants the owner's WORDS. It went red on my own edit, which is the gate working. | 296 -> 297 (2026-08-13, #479): ONE new HR11 site -- the acceptance-bar ruling re-cited in PWR2_VALIDATION sec 6, where D5 is rewritten around ANS-3.5/NEI 09-09 (directional correctness, alarm fidelity, conservation as a BUDGET) instead of residuals. | 292 -> 296 (2026-08-13, #479): FOUR new HR11 citation sites -- the second wave of rulings (solver iteration cap, keep integrated momentum, HEM stands with its cost recorded, continue at ~12 nodes with a changed acceptance bar), taken after the industry research. All four are SELECTIONS from options I wrote and are marked as such. | 291 -> 292 (2026-08-13, #479): the same owner ruling re-cited in PWR2_PHYSICS sec 17.7, where the second independent attempt VINDICATED it -- the superheat branch's slope is 1.02x-7.07x too shallow against published tables, a real defect independent of the continuity question I had framed the ruling around. | 290 -> 291 (2026-08-13, #479): ONE new HR11 site -- the owner ruling to reformulate the superheat anchor and deploy independent agents, cited in PWR2_PHYSICS sec 16. | 284 -> 290 (2026-08-13, #479 PWR2 design set): SIX new HR11 citation sites in PWR2_DESIGN.md -- the five governing rulings plus the verbatim 'full new engine' directive. TRAP WORTH THE LINE: the five design documents added ZERO checks when first written, and I had predicted +4 on the assumption this gate counts FILES. It counts RULING CITATIONS. The docs recorded their governing rulings as a plain table with no date and no verbatim words -- which by CLAUDE.md's own rule made every ruling governing the design ADVISORY rather than binding. The gate's silence WAS the finding: a design set whose rulings do not bind scores the same as one with no rulings at all. Four of the six are SELECTIONS from options I wrote, marked as such. | 281 -> 284 (2026-08-13, #479 PWR2): THREE new HR11 sites, one per new Blueprint document — PWR_LOOP_GEOMETRY.md, PWR_DESIGN_BASIS.md, PWR2_ARCHITECTURE.md. All three cite owner directives with dates and verbatim words; well-formed first try, so the count moved and the compliance did not. PROVEN BY REMOVAL, not assumed: pulling PWR2_ARCHITECTURE.md alone drops the gate to 283, and pulling the whole engines/pwr2/ directory changes it by ZERO — the new ENGINE file is not what moved this, the new DOCS are. I had first written in #479 that the PWR2 work was 'additive, no existing baseline moves'; that was wrong, and this is the correction. The standing warning below applies exactly as written: these three docs were added BEFORE the aggregate was re-run, which is the only reason it was caught here rather than in CI. | MERGED 2026-08-12 (develop x workbench x backshop) — MEASURED 281: develop's 278 and backshop's 283 were BOTH wrong for this tree — they count different site sets off different bases, which is the case where taking either side whole ships a red. MEASURED after the merge and after the last text edit. |  280 -> 283 (2026-08-11, #460 the rods ship in MANUAL): THREE new HR11 sites, all citing the same 2026-08-11 directive — `pwr_control.js` at the channel, `behavior_pwr.js` at the new `rodsAuto()` helper, and `board_check.html` at the inverted default check. A FOURTH citation, the SUPERSEDED marker on #289's entry in BUILD_DECISIONS, went in BARE (no date) and failed red — the SIXTH appearance of that exact shape in this note, and again the gate caught it rather than the note. Counted after the last text edit, per the standing warning below. | MERGED 2026-08-11 (develop x workbench) — MEASURED on the merged tree, NOT summed: develop added one site and workbench two, onto the same 275 base, and this note's own history records that summing is how a red reaches origin. | 275 -> 276 (2026-08-11, #454 the chart settings window): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 strip-chart-options directive. Well-formed on the first try; the count moved, the compliance did not. AND IT WENT RED IN CI, because I ran the aggregate BEFORE writing the docs and then edited three markdown files — which is precisely what the standing warning below says not to do, in a note that already records the same trap costing a CI red on 2026-08-07. The local run_all said 47-at-baseline and was TRUE WHEN IT RAN; the write-up invalidated it afterwards. A green aggregate is only evidence about the tree it was run on. | 274 -> 275 (2026-08-11, the ten further control-room adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive block. The TUNING_LOG entry for the same work adds none — it quotes the owner in PROSE rather than in the `(OWNER DIRECTIVE, <date>: "...")` form, and only that form is a site. Counted after the last text edit. | 273 -> 274 (2026-08-11, the seven owner adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive. It went in BARE — a date with no verbatim words — and failed red, which is the FIFTH appearance of that exact shape in this note. Reading the note does not prevent it; the gate does. The TUNING_LOG entry for the same work adds NO site (it describes the directive, it does not cite it), so the count is per-CITATION, not per-document-that-mentions-it. Counted after the last text edit, per the standing warning below. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 275 -> 277 (2026-08-11, same session): the two ruling citations in the TUNING_LOG entry — the "1:A 2:A 3:A" answers and the sweep-scope selection, both in the declared-selection form. Counted AFTER the last text edit, per the standing warning below, and it was needed AGAIN: the code change measured 275 and the write-up took it to 277. The surface is per-DOCUMENT, so it moves when you write up the change, never when you make it. | 273 -> 275 (2026-08-11, #453): the scan LEARNED ARRAY-FORM CONDITIONS. `condition: ['a', {…}, {…}]` has been valid kernel syntax since #287 and both regexes here anchored on `condition:` followed by a quote or a brace, so every term in an array was invisible — including terms on continuation lines, which do not contain the word `condition` at all. #453's RHR entry gate (scrammed AND Tavg < 350 F AND subcooled) is the first array condition in the codebase, and the ONLY symptom of three unscanned permissive keys was this count going DOWN by one, as the old single `condition: 'rps_scrammed'` site vanished. No failure, no warning — a guard silently ceasing to look at protection. +3 = the three terms now scanned. Injection-verified: a bogus instrument name inside the array fails at its own line and the count stays 275. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. |  MERGED 2026-08-11 (develop x workbench, second pass) — MEASURED, not reconciled: develop added HR11 citation sites while workbench REMOVED three HR1(b) condition sites with the #453 auto-entry. Opposite signs onto a moving base is the case where taking either number whole ships a red. | 280 -> 281 (2026-08-11, #454 close-out): ONE new HR11 site, the TUNING_LOG citation confirming the LIGHTENED dashed twin on the live board. Recorded because the lightening departs from the letter of the earlier same-hue selection, so an uncited note would read as an agent overriding a ruling. Counted after the last text edit. | MERGED 2026-08-11 (develop x workbench) — MEASURED on the merged tree, NOT summed: develop added one site and workbench two, onto the same 275 base, and this note's own history records that summing is how a red reaches origin. | 275 -> 276 (2026-08-11, #454 the chart settings window): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 strip-chart-options directive. Well-formed on the first try; the count moved, the compliance did not. AND IT WENT RED IN CI, because I ran the aggregate BEFORE writing the docs and then edited three markdown files — which is precisely what the standing warning below says not to do, in a note that already records the same trap costing a CI red on 2026-08-07. The local run_all said 47-at-baseline and was TRUE WHEN IT RAN; the write-up invalidated it afterwards. A green aggregate is only evidence about the tree it was run on. | 274 -> 275 (2026-08-11, the ten further control-room adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive block. The TUNING_LOG entry for the same work adds none — it quotes the owner in PROSE rather than in the `(OWNER DIRECTIVE, <date>: "...")` form, and only that form is a site. Counted after the last text edit. | 273 -> 274 (2026-08-11, the seven owner adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive. It went in BARE — a date with no verbatim words — and failed red, which is the FIFTH appearance of that exact shape in this note. Reading the note does not prevent it; the gate does. The TUNING_LOG entry for the same work adds NO site (it describes the directive, it does not cite it), so the count is per-CITATION, not per-document-that-mentions-it. Counted after the last text edit, per the standing warning below. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 275 -> 277 (2026-08-11, same session): the two ruling citations in the TUNING_LOG entry — the "1:A 2:A 3:A" answers and the sweep-scope selection, both in the declared-selection form. Counted AFTER the last text edit, per the standing warning below, and it was needed AGAIN: the code change measured 275 and the write-up took it to 277. The surface is per-DOCUMENT, so it moves when you write up the change, never when you make it. | 273 -> 275 (2026-08-11, #453): the scan LEARNED ARRAY-FORM CONDITIONS. `condition: ['a', {…}, {…}]` has been valid kernel syntax since #287 and both regexes here anchored on `condition:` followed by a quote or a brace, so every term in an array was invisible — including terms on continuation lines, which do not contain the word `condition` at all. #453's RHR entry gate (scrammed AND Tavg < 350 F AND subcooled) is the first array condition in the codebase, and the ONLY symptom of three unscanned permissive keys was this count going DOWN by one, as the old single `condition: 'rps_scrammed'` site vanished. No failure, no warning — a guard silently ceasing to look at protection. +3 = the three terms now scanned. Injection-verified: a bogus instrument name inside the array fails at its own line and the count stays 275. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 280 -> MEASURED (2026-08-11, #453 ruled A): the RHR auto-entry actuation is DELETED, so its three HR1(b) condition sites go with it — the scrammed/Tavg/subcooling gate that briefly replaced a one-line condition. Re-measured on the tree, never subtracted. | 275 -> 274 (#453): one fewer HR1(b) CONDITION site, not an HR11 change — the RHR auto-entry actuation carried `condition: 'rps_scrammed'` and the row is deleted. `rps_scrammed` itself stays declared and used (the P-4 MFW isolation and AFW start still carry it), so its HR1_CONDITION entry is not orphaned.   // 274 -> 275 (2026-08-11, the ten further control-room adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive block. The TUNING_LOG entry for the same work adds none — it quotes the owner in PROSE rather than in the `(OWNER DIRECTIVE, <date>: "...")` form, and only that form is a site. Counted after the last text edit. | 273 -> 274 (2026-08-11, the seven owner adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive. It went in BARE — a date with no verbatim words — and failed red, which is the FIFTH appearance of that exact shape in this note. Reading the note does not prevent it; the gate does. The TUNING_LOG entry for the same work adds NO site (it describes the directive, it does not cite it), so the count is per-CITATION, not per-document-that-mentions-it. Counted after the last text edit, per the standing warning below. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | MERGED 2026-08-11 (develop x workbench) — MEASURED on the merged tree, NOT summed: develop added one site and workbench two, onto the same 275 base, and this note's own history records that summing is how a red reaches origin. | 275 -> 276 (2026-08-11, #454 the chart settings window): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 strip-chart-options directive. Well-formed on the first try; the count moved, the compliance did not. AND IT WENT RED IN CI, because I ran the aggregate BEFORE writing the docs and then edited three markdown files — which is precisely what the standing warning below says not to do, in a note that already records the same trap costing a CI red on 2026-08-07. The local run_all said 47-at-baseline and was TRUE WHEN IT RAN; the write-up invalidated it afterwards. A green aggregate is only evidence about the tree it was run on. | 274 -> 275 (2026-08-11, the ten further control-room adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive block. The TUNING_LOG entry for the same work adds none — it quotes the owner in PROSE rather than in the `(OWNER DIRECTIVE, <date>: "...")` form, and only that form is a site. Counted after the last text edit. | 273 -> 274 (2026-08-11, the seven owner adjustments): ONE new HR11 site, the CHANGELOG citation of the 2026-08-11 directive. It went in BARE — a date with no verbatim words — and failed red, which is the FIFTH appearance of that exact shape in this note. Reading the note does not prevent it; the gate does. The TUNING_LOG entry for the same work adds NO site (it describes the directive, it does not cite it), so the count is per-CITATION, not per-document-that-mentions-it. Counted after the last text edit, per the standing warning below. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 275 -> 277 (2026-08-11, same session): the two ruling citations in the TUNING_LOG entry — the "1:A 2:A 3:A" answers and the sweep-scope selection, both in the declared-selection form. Counted AFTER the last text edit, per the standing warning below, and it was needed AGAIN: the code change measured 275 and the write-up took it to 277. The surface is per-DOCUMENT, so it moves when you write up the change, never when you make it. | 273 -> 275 (2026-08-11, #453): the scan LEARNED ARRAY-FORM CONDITIONS. `condition: ['a', {…}, {…}]` has been valid kernel syntax since #287 and both regexes here anchored on `condition:` followed by a quote or a brace, so every term in an array was invisible — including terms on continuation lines, which do not contain the word `condition` at all. #453's RHR entry gate (scrammed AND Tavg < 350 F AND subcooled) is the first array condition in the codebase, and the ONLY symptom of three unscanned permissive keys was this count going DOWN by one, as the old single `condition: 'rps_scrammed'` site vanished. No failure, no warning — a guard silently ceasing to look at protection. +3 = the three terms now scanned. Injection-verified: a bogus instrument name inside the array fails at its own line and the count stays 275. | MERGED 2026-08-10 (develop+workbench x backshop) — measured on the merged tree, NOT summed. | MERGED 2026-08-10 (develop x workbench x backshop): THREE lanes all moved this off the shared 255 and two of them independently recorded 260 for DIFFERENT reasons — taking either side whole looks obviously right (the numbers agree!) and ships a red. Measured on the merged tree. | develop: 258 -> 260 (2026-08-10-develop-a, #433): two new HR11 sites — the "Rate-compensated leg" ruling citation (a selection from options, declared as such) in BUILD_DECISIONS and TUNING_LOG. Counted after the last text edit, per the standing warning below. | 255 -> 258 (2026-08-09-develop-c): three new HR11 sites for the #398 heatup-rate ruling — the catalog EV-1 row, TUNING_LOG and BUILD_DECISIONS. Counted AFTER the last text edit, per the standing warning below, and it was needed: the count read 256 mid-session and 257 after the catalog fix. The EV-1 citation FAILED HR11 first as a bare "OWNER RULING 2026-08-09" with a date and no verbatim words — the gate caught this session's own edit, which is the fourth time that exact shape appears in this note. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | workbench: 258 -> 260 (2026-08-10, the vercel.json/.vercelignore retirement): the "Do the retirement." directive cited in BOTH CHANGELOG and TUNING_LOG. FOURTH move in two sessions, and the fourth time the prediction was made AFTER the code and BEFORE the write-up — I called this one at +1 and it is +2, because a ruling quoted in two documents is two sites. The surface is per-DOCUMENT, not per-ruling. | 257 -> 258 (2026-08-09, the in-sim GitHub-issues route): one more, the CHANGELOG citation of that directive. The ui/shell.html copy of the same quote costs nothing — shell.html is not on the HR11 surface either. THREE separate +1s in one session, each caught by run_all after I had already "finished": the surface is doc-side, so the count moves when you WRITE UP the change, never when you make it. | 255 -> 257 (2026-08-09, #413): the dev-subdomain retirement ruling is quoted twice on the HR11 surface — the TUNING_LOG entry and the CHANGELOG bullet. It is ALSO quoted in worker/src/index.js and site/stamp_version.js and those cost NOTHING, exactly as the #414 note below records: the surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js and worker/*.js are not on it. Caught by run_all, not by a mid-session grep: I counted my doc additions for citation sites BEFORE the ruling arrived and read 0, then added the quotes an hour later. The count is only true after the LAST text edit, which is what every note below says. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | backshop: 259 -> 263 (2026-08-10, the trap-list cap): the 'Cap at 25' selection cited in CLAUDE.md, Blueprint/TRAPS.md, TUNING_LOG and CHANGELOG — four new HR11 sites. The citation in test/run_doc_budget.js costs NOTHING here: the surface is .md under Blueprint/Diagnostic/Manuals/.claude plus CLAUDE/CHANGELOG/README, and a .js is not on it, so a ruling quoted only in code is invisible to this gate. | 257 -> 259 (2026-08-10, the CLAUDE.md cut pass): the lane block moved to Blueprint/LANES.md, which is ON the HR11 surface, so no citation was lost — the count went UP because four quotes are now in BOTH files, deliberately: LANES.md holds the worked case and CLAUDE.md keeps the quote beside the rule that binds. The count RISING is the proof the move was lossless; a drop would have meant a quote fell off the surface. | 255 -> 257 (2026-08-09, #432/#431): the scope+extraction selection cited in TUNING_LOG and BUILD_DECISIONS — two new HR11 sites. First written as '(OWNER SELECTION, ...)', a form the scan does not recognise AT ALL: the count stayed at 255 and nothing went red, so an unrecognised citation reads exactly like no citation. The declared-selection form is '(OWNER RULING, <date>: selected "..." ... — a selection, not verbatim words)'. | MERGED 2026-08-09 (develop x backshop): 249 -> 255, MEASURED on the merged tree. Both lanes added three HR11 sites onto the shared 249 base and both independently recorded 252, so either side taken whole would have shipped a red to origin — 3 + 3 is not 3. This is the case the note two entries down already warns about, arriving for real. | 249 -> 252 (2026-08-09, #394/#378/#420 bundle): the "Scale on the departure" ruling citation lands in the TR-1i probe comment, the BUILD_DECISIONS entry and CHANGELOG — three new HR11 sites. Landed at 251 first because the CHANGELOG was written AFTER that count, which is this note's own standing warning arriving on schedule for the fourth time: count the standalone runner after the LAST text edit. `inbox/` drafts are NOT scanned (verified by moving them out and re-counting: 252 either way), so a gitignored draft carrying a citation cannot inflate this. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner. | 249 -> 252 (2026-08-09, #414): three new HR11 sites, all in the TUNING_LOG entry — the two menu-selection rulings and the changelog-scope directive. CAUGHT THE THIRD ONE RED: it was first written as a bare "(CLAUDE.md, OWNER DIRECTIVE 2026-08-06)" with no verbatim words, which is the exact failure the 235 -> 238 note below describes, arriving in a session that had already read that note. A date without the words reads as authority while carrying none of the evidence. The other two are SELECTIONS from options I wrote and the owner picked, so they carry the declared-selection form rather than pretending to be owner prose — same load-bearing declaration as the #386 stage-3 note below. The citations in site/make_download.js and site/nav.js cost NOTHING here: the HR11 surface is Blueprint/Diagnostic/Manuals/.claude + CLAUDE/CHANGELOG/README, and site/*.js is not on it. | 248 -> 249 (2026-08-09, backshop merge): NOT the merge. develop's tip measures 249 STANDALONE — verified in a detached worktree at HEAD before merging, HR1 17 / HR5 0 / HR11 232, byte-identical to the merged tree. The 248 above was recorded mid-drafting and a later text edit added the site, which is precisely the trap the next clause warns about ("count the standalone runner AFTER the last text edit"). backshop contributed ZERO net sites: its own tree measures 244, the base value. | 246 -> 248 (2026-08-08, CW range + 60F default): the condenser-range ruling citations land in pwr_config (ref + floor), CHANGELOG, TUNING_LOG, BUILD_DECISIONS and the Rev 15 row — two net new HR11 sites in the FINAL text (an intermediate draft counted 250; the three-ruling consolidation into sequence-quotes brought it to 248 — count the standalone runner AFTER the last text edit, not mid-drafting). | 244 -> 246 (2026-08-08, load-rate ruling): the "Do the 30% increase." citation lands in TUNING_LOG + BUILD_DECISIONS — two new HR11 sites. CAUGHT BY CI again (the 228 -> 230 note's exact shape): local run_all ran after the code edits but BEFORE the session-log entries were written. | MERGED 2026-08-08 (#425 x audit-lane move): both sides added HR11 sites onto the shared 235 base — measured on the merged tree, not summed. | 240 -> 241 (2026-08-08, #425): the "Do next as recommended." ruling citation lands in TUNING_LOG + BUILD_DECISIONS + the Rev 14 row — one new HR11 site. Same forgot-the-docs-bump class as every entry below; caught by the end-of-session run_all as designed. | 235 -> 238 (2026-08-08, audit lane move): three new HR11 citation sites for the SAME 2026-08-08 ruling, one per document that has to state it — Blueprint/AUDITOR_ORIENTATION.md (+1, verified by removing the file and re-running: 235), the AUDIT_CHARTER.md rewrite (+1 net: it added the lane ruling and a §6 history restating two older ones), and the BUILD_DECISIONS 2026-08-08-backshop-a entry (+1). The charter rewrite's first draft put the dates in the BULLET PREFIX rather than inside the citation window and HR11 failed both — the format is `(OWNER RULING, <date>: "<verbatim>")` and nothing else counts. | 235 -> 240 (2026-08-08, #386 stage 3): the burn/spike ruling citations across CONTEXT §6.3, CHANGELOG, BUILD_DECISIONS, TUNING_LOG and the Rev 14 row — five new HR11 sites. Two were first written BARE ("OWNER RULING 2026-08-05: TMI-2-style" with neither verbatim words nor the declared-selection form) and the scan caught both — the ruling IS a selection, so the "a selection, not verbatim words" declaration is load-bearing, not boilerplate. | 230 -> 235 (2026-08-08, #380/#355/#358): the three same-day OWNER RULING citations land in TUNING_LOG, BUILD_DECISIONS and the Rev 14 row — five new HR11 sites. Updated WITH the docs in the same change this time (see the 228 -> 230 note below for the CI-caught version of forgetting that). | 228 -> 230 (2026-08-08): the #385 flash-ruling quotes in BUILD_DECISIONS + TUNING_LOG add two HR11 rows. CAUGHT BY CI, not locally — the docs-only commit ran run_hardrules STANDALONE (which prints its own tally and compares nothing); only run_all compares to this map. The three-comments-up warning arrived on schedule, wearing a new face: "once more AFTER the docs" must mean run_all, not the bare runner.
  ...
  'run_events.js':         { code: 0, score: '40checks 0failed', secs: 12 },
  ...
  'run_release.js':        { code: 0, score: '22checks 0failed' },   // 21 -> 22 (Alpha 1.6.0): one more CROSS pairing, as every release adds. | 20 -> 21 (Alpha 1.5.2): one more CROSS pairing, as every release adds.   // 19 -> 20 (2026-08-09, Alpha 1.5.1): same mechanism as the row below — one more CROSS pairing. | 18 -> 19 (2026-08-09, Alpha 1.5.0): one more CROSS row — the check pairs each changelog.html entry with its CHANGELOG.md heading, so it grows by one per release. 9 published entries, 9 version headings.
  ...
  'run_ops.js': {
    ...
    code: 1, score: '59/70 359passed 12failed',
