...
var BASELINES = {
  ...
  'run_release.js':        { code: 0, score: '21checks 0failed' },   // 20 -> 21 (Alpha 1.5.2): one more CROSS pairing, as every release adds.   // 19 -> 20 (2026-08-09, Alpha 1.5.1): same mechanism as the row below — one more CROSS pairing. | 18 -> 19 (2026-08-09, Alpha 1.5.0): one more CROSS row — the check pairs each changelog.html entry with its CHANGELOG.md heading, so it grows by one per release. 9 published entries, 9 version headings.
