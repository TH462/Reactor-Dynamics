 ...
 * (1000 → 850 MWe, stable hold, back to ~1000) with ANY tools — manual
  ...
  RD.SCENARIOS.pwr_shift_exam = {
    ...
    beats: [
      ...
      { id: 'intro',
        ...
        commentary: {
          learning: 'Evening watch, and tonight you are checked out: no coaching, no highlights — the shift is yours. The curve: take the grid down to 850 megawatts for the night lull, hold it steady, then bring it back to a thousand for the morning. HOW is up to you. Drive the board by hand the way you ran your load-follow shift, or open Tools → Automate and put channels to work — the examiners only read the outcome. Three things decide the grade: both moves completed, no reactor trip, and steam-generator level inside its sane band — 40 to 80 percent — when the work is judged. Small asks, settled plant, feed never forgotten. I will mark the phases quietly as you pass them.',
          industry: 'Shift examination: dispatch curve 1000 → 850 MWe (stable hold) → ~1000 MWe. Control method unrestricted: manual dispatch and/or Automate-tab channels (board starts with all channels in MAN). Grading: curve completed, zero protective actuations, SG level 40–80 % at judgment. Phase markers only; no procedural coaching. Commencing.',
        },
      ...
      { id: 'pickup_call',
        trigger: { type: 'delay', value: 1.0 },
        commentary: {
          learning: 'The lull is over — dispatch calls for the morning pickup. Bring it back to a thousand and settle it there; the grade is read at the finish.',
          industry: 'Hold phase credited. Restore ~1000 MWe. Grading at the settled finish: output > 985 MWe, SG level 40–80 %.',
        },
        branches: [
          { trigger: { type: 'scram' }, goto: 'tripped' },
          { trigger: { type: 'all', triggers: [
      ...
      { id: 'graded',
        ...
        level_complete: {
          ...
          outcome_industry: 'Dispatch curve 1000→850→1000 MWe completed without protective actuation; SG level maintained. Examination passed.',
      ...
      { id: 'shift_over',
        ...
        commentary: {
          ...
          industry: 'Examination window (50 min) expired with the curve incomplete or final conditions out of band (required: reduction credited, 180 s hold, > 985 MWe with SG 40–80 %). Re-examination via Rewind/Retry.',
        },
        level_complete: {
