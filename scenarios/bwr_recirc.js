  ...
  RD.SCENARIOS.bwr_recirc = {
    ...
    beats: [
      ...
      { id: 'intro',
        ...
        gate: { allow_actions: ['set_recirc_flow'],
      ...
      { id: 'up_task',
        ...
        commentary: {
          learning: 'Take the RECIRC FLOW up — a modest step, aim the setting around 25 — and then hands off. Watch three gauges tell one story: recirculation flow up, VOID FRACTION down, POWER up. Aim to land around 70% power.',
          industry: 'Raise recirc setting to ~25 (≈62% loop flow). Anticipate ~70% power equilibrium. Track flow / void / power coupling; no rod motion.',
        },
        advance: 'wait_for_trigger' },
      ...
      { id: 'down_task',
        ...
        commentary: {
          learning: 'Feel that? Seventy percent, no rods, and it STOPPED there by itself — the moment power outran the flow, fresh bubbles formed and braked it. You cannot easily run away in this machine; the foam always votes against you. One professional caution while you are proud of yourself: real BWR operators still respect a flow map — certain low-flow/high-power corners invite power oscillations even here. Now throttle back: return the setting toward 19 and watch the foam take the power back down.',
          industry: 'Power stabilized ~70% on void feedback alone. Caveat for realism: operating map exclusion regions (thermal-hydraulic instability at low-flow/high-power) still apply in real plants — not modeled here. Reduce recirc setting to ~19; expect return toward 50%.',
        },
        advance: 'wait_for_trigger' },
