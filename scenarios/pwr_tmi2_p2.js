    ...
    beats: [
      ...
      { id: 'p2_b0',
        ...
        dialogue: [
          ...
          { speaker: 'chief',
            learning: 'Here is what makes tonight hard. Every gauge, every alarm, every automatic protection system reads INSTRUMENTS — never the physics itself. When an instrument lies, everything built on it lies with it: the display, the annunciator, the operator, the procedure. The only thing that catches it is knowing what the plant SHOULD be doing — pressure and temperature move together, pressurizer level follows Tavg, subcooling is the margin between them. Tonight those relationships stop agreeing with the board. The relationships are the ones telling the truth.',
            industry: 'Indications, alarms and protection logic all read instruments, never true state (HR1), so a failed instrument corrupts every layer above it — display, annunciation, operator action, procedure. The discriminator is the expected coupling between parameters: P–T, level–Tavg, subcooling. TMI-2 is the canonical case of the couplings and the indications disagreeing.' },
          { speaker: 'chief',
      ...
      { id: 'p2_b9',
        ...
        dialogue: [
          ...
          { speaker: 'chief',
            learning: 'What this simulator shows and doesn\'t, said plainly: the containment side of the accident IS here now — the building pressurizes, its safeguards act, and if a core stays uncovered long enough the hydrogen from the burning cladding collects in there and goes off, once, the way TMI-2\'s did at 1:50 that afternoon. What is NOT here: the releases, the dose — the story still ends at fuel damage. And the melted fuel itself is a lump in this model — the real core damage was messier. What IS faithful is the physics of the trap. Which brings us to Part 3: same shift, same board, same lying light — and this time, YOUR hands. The goal isn\'t to spot the tricks. You know the tricks. The goal is to stabilize the plant. Go change history.',
            industry: 'Model boundaries, stated: containment pressure/temperature, its ESF, the hydrogen inventory and a one-time TMI-2-style deflagration are modeled; releases and dose are not — simulation terminates at fuel damage; the damage model is lumped. The trap physics are faithful. Part 3: identical scenario, full control authority. Objective: plant stabilization. Proceed.' },
        ],
        level_complete: {
