...
| **The way this usually happens** | A **repressurization while aligned**. The suction valve auto-closes if RCS pressure climbs back above the interlock — that protection is real and stays — and because the entry permissive is spent, pressure coming back down does **not** bring RHR back. The classic setup is a pressure-control setpoint left just above 400 psi during a cooldown: the plant hunts across the interlock, the valve shuts once, and stays shut. |
| **If it comes in with pressure ABOVE the interlock** | Expected, briefly. You cannot re-open until you are back below **400 psi (2.76 MPa)**. Get pressure down, then re-align. |
