...
**Simulator:** there is a **runnable walkthrough** for this — `pwr_post_trip`, the one you run
...
until 2026-08-03** — authoring the walkthrough found it missing, and `reset_rps` had been reachable
on the board since #75 while being named by no procedure, mission or walkthrough at all.
