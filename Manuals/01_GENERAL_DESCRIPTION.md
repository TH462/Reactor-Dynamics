...
| Containment / dose | Full models | Substantially modeled (#386 stages 1–3). Containment **pressure, temperature and sump level** exist — the building receives break and relief discharge, and break flow throttles against its rising pressure; **spray and fan coolers** act automatically on the sourced signals; **hydrogen** is generated by the oxidizing core, tracked in the building, worked by auto-starting recombiners, and can **burn once**, TMI-2-style. All automatic — no containment controls on the board yet. Nothing past fuel damage: no source term, no release, no dose. Core **damage and melt are** simulated — cladding failure at **2192 °F (1200 °C)**, fuel melt at **5072 °F (2800 °C)** |
