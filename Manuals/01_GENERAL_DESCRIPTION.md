...
| Containment / dose | Full models | Partly modeled, and the **engineered safeguards are absent by declaration**. Containment **pressure, temperature and sump level** exist — the building receives break and relief discharge, and break flow throttles against its rising pressure; **hydrogen** is generated by the oxidizing core and tracked in the building. What this plant does **not** have: **no containment spray, no fan-cooler safety realign, no hydrogen recombiners, no hydrogen burn, and nothing that reads containment pressure at all** — no isolation and no injection backup on it (**09** §3.0, **12** §12.4d–e; the fields are published permanently false so the absence is machine-readable). **The building has no way down**: once a break pressurizes it, only the passive structure brings it back. Nothing past fuel damage: no source term, no release, no dose. Core **damage and melt are** simulated — cladding failure at **2192 °F (1200 °C)**, fuel melt at **5072 °F (2800 °C)** |
