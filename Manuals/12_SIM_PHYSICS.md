...
**The ADV ships SHUT — it is a lever you reach for, not an automatic.** That is a declared departure (§12.18): a real plant's atmospheric dumps modulate on their own. Two consequences worth knowing. First, nothing changes about any bottled-generator evolution unless you open it. Second, **a fully-open ADV cools far faster than the technical-specification limit** — measured at about 300 °F/hr initially, three times the 100 °F/hr limit — so the cooldown-rate meter and the **RCS COOLDOWN RATE HI** annunciator (**A34**) are live equipment during this evolution, and throttling to stay inside the limit is the skill.
...
| 12.17 | **The steam lines isolate on flow-plus-pressure only — there is no containment-pressure path** *(new 2026-08-05, #370)* | A real plant also isolates on high-high containment pressure. This simulator has no containment at all — no pressure, no temperature, no sump — so that half of the real logic has nothing to sense and is not built. | **In one case.** A break whose signature would be containment pressurization *without* high steam flow — a small break inside containment — will not isolate here. Large breaks, the ones that matter, isolate on the flow-and-pressure coincidence. |
...
| 12.18 | **The atmospheric dump valves ship SHUT, and their size is not sourced** *(new 2026-08-05, #371 — the valves were built; this is what remains)* | A real plant's atmospheric dumps modulate automatically to hold steam pressure, and their capacity comes from the plant's design. Ours default to closed and their capacity is an engineering choice — no document in this simulator's source set names an atmospheric dump capacity for a plant of this size. | **Yes, in one way that matters.** Losing the condenser does not start a cooldown by itself: you must open the ADV. And once open, it cools **much faster than the 100 °F/hr limit** — throttle it, and watch the cooldown-rate meter (**A34**). |
