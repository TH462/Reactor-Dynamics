...
| 12.4c | **Water-solid: only the SURGE stiffens — relief, spray and the heaters keep their bubbled-plant gains** *(new 2026-08-04, #346 — before this, a solid RCS taking safety injection did not repressurize at all: the surplus mass was discarded at a numerical ceiling and pressure sat flat while ECCS ran on)* | When the pressurizer goes water-solid the only compressible volume in the RCS is gone, so an insurge compresses **liquid** and the pressure gain steps up to the bulk modulus (≈ 1.3 GPa, ~4× the bubbled gain). That much is modelled. What is **not**: a solid pressurizer's relief valves pass water rather than steam, spray has nothing to condense, and the heaters have no bubble to flash. All three keep their normal-operation gains here. The relief-only version of the correction was built and measured, and it is *worse* than leaving all three alone — it drops the relieving equilibrium ~145 psi, which un-deadheads the ECCS and lets injection out-run the PORV again | **Minor, and it errs toward calm.** A real solid plant is *harder* to control than this one: relief is stronger per unit mass, and spray and heater response are weaker. The lesson — going solid costs you the pressurizer as a pressure controller, and the relief valve becomes the pressure control — is intact, and the plant does lift and cycle its PORV on an unterminated overfill. Do not read the cycling *rate* as a real-plant figure. |
