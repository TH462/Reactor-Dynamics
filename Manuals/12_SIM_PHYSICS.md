...
> **WARNING — a declared, deliberate cliff.** The fast mode arms on a **rate**: a step load rejection must exceed **40 MWe**, or a ramp must exceed roughly 40 MWe/min. Measured (re-taken 2026-08-06): a **39 MWe rejection does not arm** and runs primary pressure to the PORV setpoint — 2350 psi (16.20 MPa), the valve catching within instrument noise of it — at Tavg 601 °F (316.1 °C); **41 MWe arms and is caught** at 580.3 °F (304.6 °C), 113 psi (0.78 MPa) clear of the relief. **Rod control in AUTO does not change this**: the shipped lineup ends at the same backstop, and its 39 MWe cut undershoots ~15 points DEEPER than a 41 MWe cut — the smaller upset is the worse plant. It is also **blind to staircases** — 60 MWe delivered as four 15 MWe steps never arms at all.
>
