...
- The containment **building** is modelled as of #386 stage 1 (2026-08-05), and as of stage 2 (2026-08-08) it has **active heat removal and protection**: spray on the sourced 30 psig high-high (auto-securing on recovery), fan-cooler safety realign on SI, the unblockable 3.5 psig SI backup, a steam-line-isolation leg, and an upstream steam-line-break source term (§12.4d). **All automatic — no containment controls exist on the board in this build** (owner ruling, pending the board redesign); the annunciators A36–A39 and the Physics tab are the window. Still missing: a pressurizer relief tank, sump recirculation, and hydrogen (stage 3)
