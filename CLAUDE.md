...
> before citing it.**
>
> **Tier C (casualties) is RULED and BINDING for the PWR** *(OWNER RULING, 2026-08-03: "Do as you
> recommend.")* — it has two bands. **CORE** (11 casualties) means the player is expected to
...
| **Argue a feature's EDUCATIONAL value (Q2)** | **`Blueprint/CURRICULUM.md`** — what each plant is meant to teach, in four tiers. PWR only. **Read the per-tier status**: Tier C (casualties) is **RULED 2026-08-03 and binding** — Core owes a mission, Covered does not; Tiers A and B are still PROPOSAL. |
