...
the channel ships on prototypicality (`run_behavior` 65, `run_contract` 157). Remaining:
stage 6 (#334 slider memo + the low-Δp break-law question — owner rules), then the
committed pzr-inventory-node follow-on. Stage list: TUNING_LOG develop-f.
