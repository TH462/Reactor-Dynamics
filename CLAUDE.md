...
uncovery (CA-18, `run_behavior` 62). Remaining: stage 3 (#384 exit — solid `saturated`
predicate), stage 4 (#384 floors — `K_break_vent` + path-scoped sat-pull, CA-15 re-author),
stage 5 (#407 core-exit subcooling + the NUREG-0737 fetch, blocked all session on nrc.gov
403 + Wayback 503), stage 6 (#334 slider memo). Stage list: TUNING_LOG develop-f.
