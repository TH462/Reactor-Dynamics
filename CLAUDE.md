...
- **A reactor trip could be switched off at full power, and 34 green runners never asked
  ...
  (12.28 MPa). Four things to know. **The AUTHORED CONTENT was right and the kernel was wrong**
  — the startup checklist already said *"the plant will not let you block them down there"* and
  *"Both blocks auto-reinstate the moment power falls back below P-10"*, and PWR-N15 already
  lowers the Pressure SP inside P-11 *"which is what makes the next two steps possible"*. So the
  2026-07-24 proactive-block rule bought the procedures **nothing** and quietly falsified the
  manual; restoring the permissive gate cost zero content. **The two fixes each heal F1 alone**,
