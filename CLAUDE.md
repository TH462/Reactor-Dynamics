...
| **Run an independent audit slice (#221)** | **`Blueprint/AUDIT_CHARTER.md`**, launched with `claude --settings .claude/settings.audit.json`. That settings file excludes **this file** and the auto-memory index, because both are always-on and dense with conclusions about the subsystems under audit — #221 RoE 1's priming problem. The charter is this file's *operating* half with the diagnosis removed. **Do not hand an auditor CLAUDE.md.** |
