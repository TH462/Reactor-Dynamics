...
| 8.17 | **Steam dump sized at 105 % of rated steam flow, not the prototypical 40 %** (ruled 2026-07-21, sourced 2026-07-31 #220) | *"In most Westinghouse units the capacity of the steam dump system is 40%"* (NRC Westinghouse Technology Systems Manual §11.2, ML11223A294), sized for a **50 % loss of load** (40 % dump + a 10 % rod step; STPEGS UFSAR §10.4.4, ML22140A078) and to keep the SG safeties seated on a trip from 100 %. CE plants: 40 % bypass + 5 % atmospheric. So a real plant of this class **cannot** ride out a full load rejection, and ours can. | **Deliberate — the FG-4 ride-out enabler.** A full load rejection is caught by the dump alone (**TR-1**), which is the signature experience: drama, then *your* recovery, with no protection theatrics. It is not without a real analog — the AP1000 is *"designed to sustain a load rejection from 100 percent power with the turbine generator continuing stable operation while supplying the plant house loads"* (DCD Rev. 19 §8.3, ML11171A483) — it is just not classic Westinghouse. **Consequence to know:** the P-9 reactor trip's real justification is dump capacity (*"for turbine trips from 50% power or less, sufficient steam dump capacity is available"*, WTSM §12.2), and that argument does **not** apply here. The trip is kept for the two reasons that survive an oversized dump — the dump depends on the condenser (real interlock C-9; **TR-8** is that case) and it is uncredited defence-in-depth in reality too (*"No credit was taken in the accident analyses for operation of these trips"*, Salem TS Bases, ML18093A272). | Size the dump at 40 % and let the P-9 trip carry a turbine trip on capacity grounds, as the real plant does — a different plant, and a different lesson. |
