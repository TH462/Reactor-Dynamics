  ...
  var PWR2 = [
    {
      ...
      steps: [
        ...
        { text: 'Open the Safety Injection Accumulator valve NOW, on the way past. Nothing opens it for you, and nothing warns you.',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Close the Safety Injection Accumulator valve NOW, inside the band. Below it the nitrogen pushes the tanks into the plant.',
