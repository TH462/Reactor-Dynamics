    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Put the turbine on line — two real actions on this plant: LATCH the turbine (un-trip it), then set a load target of 10 MWe. The generator picks up the load and the reactor follows it up to ~10 %.',
          ...
          hl: ['Turbine Load', 'Main Breaker'] },
        { text: 'Block the 35 % LOW-FLUX trip setting — now that you are above P-10 (10 % power), the permissive lets you. On the TRIP BLOCKS panel, press the block. Below P-10 the request auto-revokes; the ascension needs it standing.',
          why: 'The 35 % setting is the startup backstop: below P-10 it is what catches a runaway ascent, and the plant will not let you block it down there. Above P-10 the power-range 109 % trip takes over the job — and an unblocked 35 % setting also holds a ROD STOP that will freeze your withdrawal at ~30 %.',
      ...
      guard: { never_melted: true, never: [{ p: 'fuel_temp_c', op: '>=', v: 1200 }] },
      outcome: 'Reactor critical and in Mode 1, At Power with the generator carrying ~10 MWe and the low-flux block standing; ready for the power ascension.',
    },
    {
      ...
      from: '50_percent',
      prereq: ['Reactor critical and stable at power, above P-10.', 'Turbine on line.', 'The 35 % low-flux setting blocked (the startup checklist\'s last act).'],
      precond: [
        { p: 'power_pct', op: '>', v: 10, text: 'Reactor critical and at power (above P-10)' },
        { p: 'mwe_output', op: '>', v: 5, text: 'Turbine on line, carrying load' },
      ],
      cautions: [
        'Rods lead going UP. Raising load first drags Tavg below program and, un-blocked, runs you into the 35 % low-flux rod stop; the measured discipline is pull, load, trim.',
        'Approach 100 % gently: the POWER RANGE high-flux rod stop stands above 103 %, and the 109 % trip is behind it. Overshoot is real on this plant — 100 MWe of load lands power at ~101 %.',
      ...
      steps: [
        obs('Confirm the at-power lineup: critical, generator loaded, Feed AUTO holding SG level, the low-flux block standing.',
          { p: 'mwe_output', op: '>', v: 5 },
