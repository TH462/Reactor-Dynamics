  ...
  var PWR = [
    {
      ...
      steps: [
        ...
        { text: 'On the Primary view: Rod Speed → Slow, then hold Control Bank → Withdraw in small bursts toward criticality. Power begins to climb once you pass critical; keep the Startup Rate (SUR) low and the reactor period long.',
          ...
          note: 'Set Rod Speed to Slow first; release Withdraw to stop motion. If the period drops below 30 s, stop or insert — the reactor is accelerating.',
          cmd: { action: 'rod_nudge', group_id: 'control', steps: 26, speed: 'slow' }, hold: 220,
