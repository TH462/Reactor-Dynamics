    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Withdraw another burst toward the predicted critical position — smaller now, you are getting close (still subcritical). Let the counts settle again.',
          control: 'Control Bank', target: 'nearing critical',
          cmd: { action: 'rod_nudge', group_id: 'control', steps: 90, speed: 'normal' }, hold: 60,
          acc: { p: 'reactivity_pcm', op: '>', v: -300 },
          hl: ['Control Bank', 'Source Range', 'Reactivity'] },
        ...
        { text: 'Creep up on criticality: withdraw at Slow in single steps. The reactor goes critical and power begins to climb — watch the Startup Rate (SUR) and keep the reactor period long.',
          ...
          cmd: { action: 'rod_nudge', group_id: 'control', steps: 45, speed: 'slow' }, hold: 150,
          saw: { p: 'startup_rate_dpm', op: '>', v: 0 }, acc: { p: 'power_pct', op: '>', v: 1 },
          hl: ['Control Bank', 'Startup Rate', 'Reactivity'] },
        { text: 'Arrest the rise and hold power in the low-power band: insert a few steps to level off. The lumped core overshoots, so lead the level-off — bring reactivity back toward zero as power settles.',
          control: 'Control Bank', target: 'power steady, ~5–15 %',
          cmd: { action: 'rod_nudge', group_id: 'control', steps: -8, speed: 'slow' }, hold: 150,
