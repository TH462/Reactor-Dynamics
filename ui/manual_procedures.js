  ...
  var PWR = [
    {
      ...
      steps: [
        ...
        { text: 'Select Rod Speed → Slow, then hold Control Bank → Withdraw in small bursts toward criticality. Power begins to climb once you pass critical; keep the Startup Rate (SUR) low and the reactor period long.',
          control: 'Control Bank → Withdraw (hold); Rod Speed → Slow', target: 'SUR ≤ 1 DPM, reactor period ≥ 30 s',
    ...
    },
    {
      ...
      steps: [
        { text: 'Withdraw the Control Rods a few steps to add reactivity.', control: 'Rod Speed → +1',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Insert the Control Rods a few steps to lower reactor power.', control: 'Rod Speed → −1',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Start Auxiliary Feedwater (AFW) to restore the secondary heat sink.', control: 'AFW → Start', target: 'core cooled',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'ISOLATE the leak: on the Primary view, PORV Block Valve → Isolate. This stops the loss even though the PORV itself is stuck open.', control: 'PORV Block Valve → Isolate', target: 'inventory stops falling',
  ...
  var RBMK = [
    {
      ...
      steps: [
        ...
        { text: 'Select Rod Speed → Slow, then hold Control Bank → Withdraw toward criticality; watch the Startup Rate (SUR) and the Operating Reactivity Margin (ORM).',
          control: 'Control Bank → Withdraw (hold); Rod Speed → Slow', target: 'SUR low, ORM above minimum',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Initiate AZ-5 promptly to shut the reactor down.', control: 'AZ-5', target: 'power collapsing',
  ...
  var BWR = [
    {
      ...
      steps: [
        ...
        { text: 'Hold Control Bank → Withdraw to reach criticality and start the climb; the negative void feedback keeps it stable.',
          control: 'Control Bank → Withdraw (hold)', target: 'positive SUR, controlled climb',
    ...
    },
    {
      ...
      steps: [
        { text: 'Increase the Recirculation (recirc) flow setpoint. On the Primary view, raise Recirc Drive Flow → Set %. Fewer voids → positive reactivity → power rises and self-limits.',
          control: 'Recirc Drive Flow', target: 'power rises to a new balance',
    ...
    },
    {
      ...
      steps: [
        ...
        { text: 'Start Reactor Core Isolation Cooling (RCIC) — Secondary view → RCIC → On. It runs on reactor steam and battery power, no AC needed.',
          control: 'RCIC → On', target: 'vessel level held', cmd: { action: 'set_rcic', active: true }, hold: 300, acc: { p: 'vessel_level_pct', op: '>', v: 40 } },
