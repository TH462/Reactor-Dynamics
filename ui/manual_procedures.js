 ...
 *     sourced 4-12 band), so the whole 1/M ladder re-derives (#602 phase 2);
  ...
  var PWR2 = [
    ...
    },
    {
      ...
      cautions: [
        'Startup rate (SUR) limit for the approach: 1 decade per minute (DPM). One control-bank step is worth about 8 pcm near the critical band, and the bank spans 627 steps. Steps add up; the rate is the warning.',
        'The 1/M prediction reads high early and walks down as points are added. Measured on this plant: criticality between 226 and 238 of 627 steps from the 719 ppm start.',
      ...
      steps: [
        ...
        { text: 'Open the 1/M PLOT tool and press Plot point before any rod moves. This is the 1.0 reference.',
          ...
          hl: ['1/M Plot Tool', 'Source Range'] },
        { text: 'Withdraw the control bank to 94 steps at MED, let the counts settle, then press Plot point.',
          ...
          control: 'Control Bank', target: '94 of 627, point 2 (an over-estimate)',
        ...
        { text: 'Withdraw to 157 steps at MED, settle, then press Plot point. The prediction pulls in but still reads high.',
          ...
          control: 'Control Bank', target: '157 of 627, point 3',
          ...
          accs: [{ p: 'sr_counts_cps', op: '>', v: 1400, label: 'Counts settled above 1,400 cps' },
                 { cmd: 'plot_1m_point', label: 'Point plotted' }],
          hl: ['Withdraw', '1/M Plot Tool', 'Source Range', 'Startup Rate'] },
        { text: 'Withdraw to 188 steps at MED, settle, then press Plot point. The fit now lands within a dozen steps.',
          ...
          control: 'Control Bank', target: '188 of 627, point 4',
          ...
          accs: [{ p: 'sr_counts_cps', op: '>', v: 3000, label: 'Counts settled above 3,000 cps' },
                 { cmd: 'plot_1m_point', label: 'Point plotted' }],
          hl: ['Withdraw', '1/M Plot Tool', 'Source Range', 'Startup Rate'] },
        { text: 'Withdraw to 202 steps at MED, settle, then press Plot point. Keep bursts small so SUR stays under 1 DPM.',
          ...
          control: 'Control Bank', target: '202 of 627, point 5',
          ...
          accs: [{ p: 'sr_counts_cps', op: '>', v: 7000, label: 'Counts settled above 7,000 cps' },
                 { cmd: 'plot_1m_point', label: 'Point plotted' }],
          hl: ['Withdraw', '1/M Plot Tool', 'Source Range', 'Startup Rate'] },
        { text: 'Withdraw to 211 steps, settle, then press Plot point. Point 6 is the working number; it still reads slightly high.',
          ...
          control: 'Control Bank', target: '211 of 627, the working prediction (true critical 226 to 238)',
          ...
          accs: [{ p: 'sr_counts_cps', op: '>', v: 20000, label: 'Counts settled above 20,000 cps' },
                 { cmd: 'plot_1m_point', label: 'Point plotted' }],
          hl: ['Withdraw', '1/M Plot Tool', 'Source Range', 'Startup Rate'] },
        { text: 'Withdraw at SLOW to 226 steps and creep onto criticality. Measured: SUR peaks near 0.9 DPM.',
          why: 'One step of this bank is about 8 pcm, so no single step is dramatic, but fifteen of them are, and the rate is what tells you. SLOW spreads the insertion so the rate meter can answer while your finger is still on the button. The discipline here is patience, not precision. Measured, the reactor arrives just past critical, near +145 pcm.',
          control: 'Control Bank', target: '226 of 627: critical, SUR at or under 1 DPM',
        ...
        { text: 'Withdraw two more steps at SLOW, to 228. Power climbs through the decades. Watch SUR and the intermediate range.',
        ...
        { text: 'Insert 14 steps at MED in one drive, released as SUR crosses zero. Power settles near 1 %.',
        ...
        { text: 'Withdraw 13 steps at SLOW. Power rises into the high single digits and the plant enters Mode 1, At Power.',
