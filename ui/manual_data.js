    ...
    "pwr": {
      ...
      "controls": [
        ...
        },
        {
          ...
          "group": "Reactivity",
          "uses": "Energizes/secures the Source Range (SR) startup counter. P-6 interlocked: it cannot be switched OFF until the Intermediate Range is on scale (you would go blind), and cannot be switched ON at high flux (detector protection). Its 1e5 cps high-flux trip protects a startup — secure it during the SR→IR handoff.",
          "command": "set_sr_detector",
          "params": "{on}"
        },
        {
          "control": "Startup Trip Blocks (IR / PR low setpoint)",
          "group": "Safety",
          "uses": "Blocks the Intermediate Range high-flux trip or the Power Range LOW-SETPOINT (25 %) trip during a power ascension. Permitted only above the P-10 at-power permissive (10 %); both blocks auto-reinstate when power falls back below it.",
          "command": "set_trip_block",
      ...
      "glossary": [
        ...
        {
          "acronym": "SR",
          "term": "Source Range — the startup neutron counter (counts per second)."
        },
        {
          "acronym": "IR",
          "term": "Intermediate Range — compensated ion chamber (amperes) carrying the indication to ~10 % power."
        },
        {
          "acronym": "P-6",
          "term": "Permissive: IR on scale (≥ 1e-10 A) — allows securing the SR detector."
        },
        {
          "acronym": "P-10",
      ...
      "normal_values": {
        "hot_full_power": {
          ...
          "true_state": {
            ...
            "p_hotleg": 15.41,
            "p_pumpsuction": 15.16,
            "suction_subcool_c": 56.129,
            "rcp_cavitation_frac": 0,
            "rcp_cavitating": false,
            ...
            "reactor_period_s": -677155365.768,
            "plant_mode": 1,
            "plant_mode_name": "At Power",
            "tavg_rate_c_per_hr": 0.00254,
            "sr_counts_cps": 0,
            "ir_amps": 0.00833,
            "sr_energized": false,
            "msiv_open": true,
          ...
          "instruments": {
            ...
            "thot": 320.595,
            "tcold": 287.649,
            "primary_pressure": 15.414,
            "pzr_level": 55.649,
            "sg_level": 65.052,
            "steam_flow": 1.01,
            "fw_flow": 1,
            "mwe_output": 999.864,
            "turbine_rpm": 1799.127,
            "condenser_vacuum": 96.642,
            "charging_flow": 0.000556,
            "letdown_flow": 0,
            "steam_pressure": 5.652,
            "boron_analyzer": 753.343,
            "governor_valve": 99.905,
            "hpi_flow": 0.0043,
            "accumulator_flow": 0.0021,
            "steam_dump_valve": 0,
            "primary_leak_flow": 0,
        ...
        "hot_zero_power": {
          ...
          "true_state": {
            ...
            "tcold_c": 302.644,
            "pressure_mpa": 15.411,
            "pzr_level_pct": 55.049,
            "sg_level_pct": 65,
            "p_coldleg": 15.711,
            "p_hotleg": 15.411,
            "p_pumpsuction": 15.161,
            "suction_subcool_c": 41.061,
            "rcp_cavitation_frac": 0,
            "rcp_cavitating": false,
            "steam_flow_normalized": 0.00000105,
            ...
            "plant_mode": 3,
            "plant_mode_name": "Hot Standby",
            "tavg_rate_c_per_hr": 16.393,
          ...
          "instruments": {
            ...
            "thot": 302.909,
            "tcold": 302.645,
            "primary_pressure": 15.405,
            "pzr_level": 56.045,
            "sg_level": 64.566,
            "steam_flow": 0,
            "fw_flow": 0,
            "mwe_output": 0,
            "turbine_rpm": 1800.058,
            "condenser_vacuum": 96.797,
            "charging_flow": 0.000326,
            "letdown_flow": 0.000174,
            "steam_pressure": 8.886,
            "boron_analyzer": 354.559,
            "governor_valve": 0.14,
            "hpi_flow": 0,
            "accumulator_flow": 0,
            "steam_dump_valve": 0,
            "primary_leak_flow": 0.00277,
            "startup_rate": -0.011,
            "porv_tailpipe_temp": 80.379,
            "source_range": 478.751,
            "intermediate_range": 8.64e-9,
            "porv_indicator": "closed",
            "subcooling_margin": 42.205,
            "rps_scrammed": false,
            "rcp_running": true,
            "hpi_active": false,
            "station_blackout": false,
        ...
        "5_percent": {
          ...
          "true_state": {
            ...
            "p_hotleg": 15.41,
            "p_pumpsuction": 15.16,
            "suction_subcool_c": 71.09,
            "rcp_cavitation_frac": 0,
            "rcp_cavitating": false,
            "steam_flow_normalized": 0.06,
            "fw_flow_normalized": 0.06,
            "steam_pressure_mpa": 5.65,
            "mwe_output": 59.985,
            "subcooling_c": 71.446,
            "core_inventory_pct": 100,
            ...
            "scrammed": false,
            "melted": false,
            "steam_demand_mwe": 59.999,
            "load_mode": "follow",
            "load_target_mwe": 59.999,
            "load_imbalance_mwe": 1.375,
            "sg_imbalance_active": false,
            "reactivity_pcm": -0.21,
            "startup_rate_dpm": -0.00155,
            "reactor_period_s": -16769.312,
            "plant_mode": 1,
            "plant_mode_name": "At Power",
            "tavg_rate_c_per_hr": -0.0037,
            "sr_counts_cps": 0,
            "ir_amps": 0.0005,
            "sr_energized": false,
            "msiv_open": true,
          ...
          "instruments": {
            ...
            "charging_flow": 0.000326,
            "letdown_flow": 0.000174,
            "steam_pressure": 5.636,
            "boron_analyzer": 632.837,
            "governor_valve": 6.14,
            "hpi_flow": 0,
            "accumulator_flow": 0,
            "steam_dump_valve": 0,
            ...
            "porv_tailpipe_temp": 80.379,
            "source_range": 1,
            "intermediate_range": 0.000518,
            "porv_indicator": "closed",
            "subcooling_margin": 71.23,
            "rps_scrammed": false,
            "rcp_running": true,
            "hpi_active": false,
            "station_blackout": false,
        ...
        "50_percent": {
          ...
          "true_state": {
            ...
            "reactor_period_s": -24769.174,
            "plant_mode": 1,
            "plant_mode_name": "At Power",
            "tavg_rate_c_per_hr": -1.298,
            "sr_counts_cps": 0,
            "ir_amps": 0.00415,
            "sr_energized": false,
            "msiv_open": true,
          ...
          "instruments": {
            ...
            "charging_flow": 0.000556,
            "letdown_flow": 0,
            "steam_pressure": 5.653,
            "boron_analyzer": 760.456,
            "governor_valve": 49.838,
            "hpi_flow": 0.0043,
            "accumulator_flow": 0.0021,
            "steam_dump_valve": 0,
            "primary_leak_flow": 0,
        ...
        "cold_shutdown": {
          ...
          "true_state": {
            ...
            "p_hotleg": 2.5,
            "p_pumpsuction": 2.5,
            "suction_subcool_c": 173.409,
            "rcp_cavitation_frac": 0,
            "rcp_cavitating": false,
            "steam_flow_normalized": 1.85e-7,
            "fw_flow_normalized": 0.000001,
            "steam_pressure_mpa": 0.1,
            "mwe_output": 0.001,
            "subcooling_c": 173.408,
            "core_inventory_pct": 100,
            "core_void_fraction": 0,
            "fuel_temp_c": 50,
            "decay_heat_pct": 1.27e-8,
            "xenon_pct_eq": 9.6e-10,
            "boron_ppm": 494.611,
            "porv_open": false,
            "porv_stuck": false,
            ...
            "sg_imbalance_active": false,
            "reactivity_pcm": -1000,
            "startup_rate_dpm": -6.95e-7,
            "reactor_period_s": null,
            "plant_mode": 5,
            "plant_mode_name": "Cold Shutdown",
            "tavg_rate_c_per_hr": 0.000767,
            "sr_counts_cps": 500,
            "ir_amps": 8.33e-9,
            "sr_energized": true,
            "msiv_open": true,
            ...
            "steam_dump_valve_pct": 0,
            "leak_flow": 0,
            "governor_valve_pct": 0.00104,
            "accumulators_discharging": false,
            "accumulator_flow_normalized": 0,
            "accumulator_volume_pct": 100,
            "rhr_active": true,
            "accumulator_valve_open": false,
            "rhr_valve_open": true,
            "eccs_mode": "RHR"
          },
          "instruments": {
            ...
            "charging_flow": 0.000326,
            "letdown_flow": 0.000174,
            "steam_pressure": 0.086,
            "boron_analyzer": 501.078,
            "governor_valve": 0.141,
            "hpi_flow": 0,
            "accumulator_flow": 0,
            "steam_dump_valve": 0,
            "primary_leak_flow": 0.00277,
            "startup_rate": -0.01,
            "porv_tailpipe_temp": 80.379,
            "source_range": 478.773,
            "intermediate_range": 8.64e-9,
            "porv_indicator": "closed",
            "subcooling_margin": -8.714,
            "rps_scrammed": false,
            "rcp_running": false,
            "hpi_active": false,
            "station_blackout": false,
