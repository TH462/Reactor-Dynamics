# PWR Behavior Gap Report — the tuning packet (part A of 3)
...
**this report covers only part A; the other parts are `BEHAVIOR_GAP_REPORT_B.md`, `BEHAVIOR_GAP_REPORT_C.md`.**
...
Battery result: 24 pass, 1 known gaps (xfail).
