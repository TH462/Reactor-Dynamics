...
var CTL = {
  ...
  set_feedwater_flow:{ g: 'Secondary', c: 'Feedwater Flow', u: 'Sets the make-up water flow to the boiler, as a percent of rated; used to control level.', cmd: 'set_feedwater_flow', p: '{pct}' },
...
var CONTROL_SETS = {
  pwr: ['rod_start', 'rod_nudge', 'rod_stop', 'rod_stop_all', 'scram', 'set_boron_adjust', 'set_charging_pump',
        ...
        'set_feedwater_flow', 'set_afw', 'set_afw_flow', 'set_esf_auto', 'set_steam_demand', 'set_steam_dump', 'set_hpi', 'set_dhr', 'automate'],
