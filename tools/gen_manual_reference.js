...
var CTL = {
  ...
  set_dhr:           { g: 'Safety', c: 'Decay-Heat Removal (alias)', u: 'Deprecated one-release alias for the RHR suction valve (set_rhr) — kept for save-file compatibility.', cmd: 'set_dhr', p: '{active}' },
